            ...
            for sensor, value in readings:
                ...
                if sensor == Sensor.STAGE_ABSOLUTE_ANGLE:
                    ...
                    if self._active_command is not None:
                        print("Speed: %.2f from %.2f (Freq %.2f Ist-F: %.2f, Stopped: %s)" % (value, self._active_command.speed, self.speed_controller.frequency or 0.0, self.motor.get_current_frequency(), self.stopped))
